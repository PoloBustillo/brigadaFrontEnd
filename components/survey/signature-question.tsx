/**
 * ✍️ SIGNATURE QUESTION — Signature capture placeholder
 * Shows a clear "coming soon" card with themed styling.
 * Phase 2 will add a canvas-based signature pad.
 */
...
export function SignatureQuestion({
  ...
  return (
    ...
    >
      ...
      >
        <Ionicons name="pencil-outline" size={32} color={colors.warning} />
      </View>
      <Text style={[styles.title, { color: colors.text }]}>Firma digital</Text>
      <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
        Esta funcionalidad estará disponible próximamente con un canvas para
        captura de firma.
      </Text>
