...
export const APELLIDOS_COMUNES = new Set([
  ...
  "RODRIGUEZ", "PEREZ", "SANCHEZ", "RAMIREZ", "CRUZ",
  "FLORES", "GOMEZ", "MORALES", "VAZQUEZ", "JIMENEZ",
  "REYES", "DIAZ", "TORRES", "GUTIERREZ", "RUIZ",
  "MENDOZA", "AGUILAR", "MORENO", "CASTILLO", "ROMERO",
  "ALVAREZ", "ORTIZ", "JUAREZ", "SANTIAGO", "HERRERA",
  "MEDINA", "CASTRO", "GUZMAN", "VARGAS", "VELAZQUEZ",
  "RAMOS", "CONTRERAS", "DOMINGUEZ", "GUERRERO", "LARA",
  "SANTOS", "BAUTISTA", "LUNA", "SALAZAR", "CHAVEZ",
  "SILVA", "NUÑEZ", "NUNEZ", "RIOS", "ROJAS",
  "DELGADO", "DE LA CRUZ", "SOTO", "VEGA", "FERNANDEZ",
  "LEON", "AVILA", "MEJIA", "ESPINOZA", "CERVANTES",
  "RIVERA", "CAMPOS", "ALVARADO", "PADILLA", "CORTEZ",
  "CORTES", "SANDOVAL", "FIGUEROA", "IBARRA", "ESTRADA",
  "CAMACHO", "BRAVO", "GALLEGOS", "ACOSTA", "VALDEZ",
  "VALDES", "CABRERA", "MORA", "NAVA", "NAVARRO",
  "PACHECO", "OLVERA", "FUENTES", "TREJO", "SOLIS",
  "SALINAS", "CARDENAS", "OROZCO", "ROSALES", "SERRANO",
  "TAPIA", "MEZA", "VERA", "BECERRA", "MARQUEZ",
  "PALACIOS", "CALDERON", "VILLEGAS", "AYALA", "VELASCO",
  "CORONA", "ARELLANO", "MALDONADO", "CARRILLO", "ZUÑIGA",
  "ZUNIGA", "MAYA", "DURAN", "ESPINOSA", "PONCE",
  "CISNEROS", "OCHOA", "PINEDA", "LEAL", "ROBLES",
  "HUERTA", "AGUIRRE", "GARZA", "BARRERA", "MONTOYA",
  "MONTES", "RUBIO", "BERNAL", "FRANCO", "BARAJAS",
  "VILLANUEVA", "SUAREZ", "ZAVALA", "RANGEL", "ESCOBAR",
  "ZARATE", "MACIAS", "VILLAGOMEZ", "ARROYO", "LEYVA",
  "MARIN", "ALONSO", "ZAPATA", "MURILLO", "GALINDO",
  "BELTRAN", "OSORIO", "CASTAÑEDA", "CASTANEDA", "ZAMORA",
  "BALDERAS", "CANO", "RICO", "ENRIQUEZ", "MOLINA",
  "CARBAJAL", "CUEVAS", "ANDRADE", "VILLARREAL", "CORTEZ",
  "MUNOZ", "MUÑOZ", "PAREDES", "PEÑA", "PENA",
  "TRINIDAD", "CORONADO", "MAGAÑA", "MAGANA", "OLIVA",
  "OLIVAS", "CABALLERO", "BUSTAMANTE", "SOLANO", "NAJERA",
  "DE LEON", "DE JESUS", "BARRIOS", "ESQUIVEL", "PALMA",
  "ROSAS", "FELIX", "MIRANDA", "MERCADO", "QUINTERO",
  "ALARCON", "PERALTA", "GARIBAY", "ROJO", "TELLEZ",
  "YAÑEZ", "YANEZ", "MATA", "BECERRIL", "VERGARA",
  "ALCALA", "TOVAR", "CARMONA", "PANTOJA", "SAAVEDRA",
  "CENTENO", "SORIANO", "GUILLEN", "ALEMAN", "ARANDA",
]);
...
export const NOMBRES_COMUNES = new Set([
  // Hombres
  "JOSE", "JUAN", "LUIS", "CARLOS", "MIGUEL", "ANGEL",
  "FRANCISCO", "JESUS", "ANTONIO", "PEDRO", "ALEJANDRO",
  "JORGE", "SERGIO", "FERNANDO", "RICARDO", "DANIEL",
  "RAFAEL", "MANUEL", "MARIO", "ROBERTO", "DAVID",
  "EDUARDO", "ARTURO", "ENRIQUE", "JAVIER", "ALBERTO",
  "OSCAR", "RAUL", "MARCO", "MARCOS", "VICTOR",
  "HUGO", "MARTIN", "RAMON", "GABRIEL", "HECTOR",
  "GUSTAVO", "GUILLERMO", "ALFREDO", "ANDRES", "PABLO",
  "GERARDO", "CESAR", "ARMANDO", "ADRIAN", "FELIPE",
  "RUBEN", "SANTIAGO", "OMAR", "EDGAR", "IVAN",
  "IGNACIO", "JAIME", "SAMUEL", "RODRIGO", "DIEGO",
  "ERNESTO", "ROGELIO", "ALDO", "JULIO", "SAUL",
  "LEONARDO", "GILBERTO", "JONATHAN", "CHRISTIAN", "ISRAEL",
  "SALVADOR", "ISMAEL", "ABEL", "EMILIO", "AARON",
  "TOMAS", "BENJAMIN", "ALAN", "AXEL", "ULISES",
  "LEONEL", "ALEXIS", "ALONSO", "ESTEBAN", "NOEL",
  "MOISES", "JOEL", "MISAEL", "URIEL", "KEVIN",
  "BRANDON", "BRYAN", "GIOVANNI", "CRISTIAN", "EMMANUEL",
  "ERICK", "ERIK", "ABRAHAM", "ISAAC", "EFRAIN",
  // Mujeres
  "MARIA", "GUADALUPE", "MARGARITA", "JOSEFINA", "PATRICIA",
  "ROSA", "ELIZABETH", "TERESA", "ANA", "ALEJANDRA",
  "ADRIANA", "DIANA", "CLAUDIA", "LAURA", "LETICIA",
  "SILVIA", "MARTHA", "ALICIA", "VERONICA", "NORMA",
  "MONICA", "GABRIELA", "SANDRA", "IRMA", "CARMEN",
  "BEATRIZ", "ELENA", "ISABEL", "YOLANDA", "ROCIO",
  "GRACIELA", "LUCIA", "ANGELICA", "ESTHER", "GLORIA",
  "BLANCA", "CECILIA", "JUANA", "ELSA", "MARISOL",
  "ESPERANZA", "LOURDES", "ARACELI", "KARLA", "JESSICA",
  "ERIKA", "LIZBETH", "AMPARO", "DOLORES", "SOLEDAD",
  "CRISTINA", "VIRIDIANA", "NAYELI", "FERNANDA", "DULCE",
  "ITZEL", "FATIMA", "PAOLA", "BRENDA", "DANIELA",
  "VANESSA", "CAROLINA", "VALERIA", "NATALIA", "XIMENA",
  "SOFIA", "CAMILA", "RENATA", "VALENTINA", "REGINA",
  "ANDREA", "JIMENA", "LUCIANA", "FRIDA", "MIRANDA",
]);

// ── Nombre compuesto frecuente (se buscan como bloque) ──────────────────────
// "JOSE LUIS", "MARIA GUADALUPE", etc.
export const NOMBRES_COMPUESTOS = new Set([
  "JOSE LUIS", "JOSE ANTONIO", "JOSE MANUEL", "JOSE ANGEL",
  "JOSE FRANCISCO", "JOSE GUADALUPE", "JOSE ALFREDO", "JOSE ALBERTO",
  "JOSE MIGUEL", "JOSE CARLOS", "JOSE RAMON", "JOSE ALEJANDRO",
  "JOSE EDUARDO", "JOSE MARIA", "JOSE DE JESUS", "JOSE MARTIN",
  "JUAN CARLOS", "JUAN ANTONIO", "JUAN MANUEL", "JUAN JOSE",
  "JUAN PABLO", "JUAN DANIEL", "JUAN LUIS",
  "LUIS ANGEL", "LUIS ALBERTO", "LUIS ENRIQUE", "LUIS FERNANDO",
  "LUIS ANTONIO", "LUIS MIGUEL",
  "MIGUEL ANGEL", "MARCO ANTONIO",
  "CARLOS ALBERTO", "CARLOS EDUARDO",
  "MARIA GUADALUPE", "MARIA FERNANDA", "MARIA ELENA",
  "MARIA ELENA", "MARIA DEL CARMEN", "MARIA TERESA",
  "MARIA ELENA", "MARIA LUISA", "MARIA DEL ROSARIO",
  "MARIA ISABEL", "MARIA JOSE", "MARIA DE LOS ANGELES",
  "MARIA DE JESUS", "MARIA DOLORES", "MARIA EUGENIA",
  "MARIA ALEJANDRA", "MARIA DEL PILAR", "MARIA SOLEDAD",
  "ANA MARIA", "ANA LAURA", "ANA KAREN", "ANA PATRICIA",
  "ROSA MARIA", "ROSA ISELA",
]);
...
export function scoreAsNombre(text: string): number {
  ...
  for (const w of words) {
    ...
    else if (APELLIDOS_COMUNES.has(fixed)) totalScore += 0.6; // apellido como nombre es raro pero posible
...
export function scoreAsApellido(text: string): number {
  ...
  if (
    APELLIDOS_COMUNES.has(clean) ||
    APELLIDOS_COMUNES.has(words.join(" "))
  ) {
    return 1.0;
  }
  ...
  for (const w of words) {
    ...
    else if (NOMBRES_COMUNES.has(fixed)) totalScore += 0.3; // nombre como apellido es posible pero raro
    else if (/^[A-ZÁÉÍÓÚÑÜ]{2,}$/.test(fixed)) totalScore += 0.4;
    else if (/^(DE|DEL|LA|LOS|LAS)$/i.test(w)) totalScore += 0.8; // partículas de apellido
    else totalScore += 0.1;
  }
  return Math.min(totalScore / words.length, 1.0);
}
...
export function matchCurpInitials(
  ...
  if (curp.length < 4) {
    return { paternoMatch: false, maternoMatch: false, nombreMatch: false, score: 0 };
  }
  ...
  let score = 0;
  let checks = 0;
  if (ap.length > 0) { checks++; if (paternoMatch) score++; }
  if (ap.length > 1) { checks++; if (paternoVowelMatch) score++; }
  if (am.length > 0) { checks++; if (maternoMatch) score++; }
  if (nm.length > 0) { checks++; if (nombreMatch) score++; }
